...
Predecir el gasto turístico de los visitantes e Identificar perfiles de visitantes mediante técnicas de segmentación

Técnicas utilizadas

Regresión múltiple, Regresión polinomial, KNN de regresión, Random Forest de regresión y K-Prototypes para análisis de conglomerados con variables mixtas

Tecnologías y herramientas

Python, scikit-learn, Matplotlib y Seaborn y Google Colab
